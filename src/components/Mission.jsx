          ...
          <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
            <div className="w-20 h-20 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-5 flex-shrink-0">
              <svg
                ...
                id="success-mission"
              >
                <path d="M64.4 26.1c.8 0 1.6-.4 2-1.1.2-.4.3-.8.3-1.1s-.1-.8-.3-1.1l-4.6-8c-.1-.1-.1-.2 0-.3l4.6-8c.4-.7.4-1.5 0-2.3-.4-.7-1.2-1.1-2-1.1H37.9c-.6 0-1 .4-1 1v35.3c-.2.1-.5.1-.7.2-.2.1-.3.2-.5.3h-.1c-.1.1-.2.1-.3.2-.2.1-.3.3-.4.4-.2.2-.4.5-.5.8L22.9 60.6v.1L2.1 95.4c-.2.3-.2.7 0 1 .2.3.5.5.9.5h69.4c.4 0 .7-.2.9-.5.2-.3.2-.7 0-1L52.6 60.7 41.1 41.4c-.1-.2-.2-.3-.3-.5-.1-.1-.2-.3-.3-.4-.2-.2-.5-.5-.8-.6-.3-.2-.5-.3-.8-.4V26.1h25.5zM39.3 42.3l10.6 17.8H25.5l10.7-17.9c.1-.3.3-.5.6-.7.2-.1.4-.2.7-.2.1.1.3.1.4.1.1 0 .2 0 .3-.1.2 0 .3.1.4.2.3.3.5.5.7.8z"></path>
                <path d="m81 68.3-9.2-14.8-.5-.8-.3-.3c-.2-.2-.5-.3-.8-.5-.4-.2-.9-.3-1.3-.3h-.5c-.1 0-.3 0-.4.1-.4.1-.8.3-1.2.6l-.3.3c-.2.2-.4.4-.5.7L58.1 66 75 94.3c.5.8.5 1.7.2 2.5H97c.4 0 .7-.2.9-.5.2-.3.2-.7 0-1L81 68.3zm-21.6-.6 8.3-13.4c.2-.4.6-.7 1.1-.7.5 0 .9.3 1.2.8l8.3 13.3H59.4z"></path>
              </svg>
            </div>
